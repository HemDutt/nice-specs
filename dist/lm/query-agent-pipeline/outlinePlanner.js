...
exports.OutlinePlanner = void 0;
class OutlinePlanner {
    plan(scope, inventory, harvest, childSummaries) {
        const responsibilities = dedupeStrings(harvest.facts.flatMap((fact) => fact.responsibilities).filter(Boolean));
...
function buildDataFlowSummary(facts) {
...
function collectDependencies(facts) {
...
function buildRiskList(scope, inventory, childSummaries) {
    const risks = [];
...
//# sourceMappingURL=outlinePlanner.js.map